class Juego {
    ...
    constructor() {
        ...
        this.#respuestas_correctas = [
            ...
            ["¿Cuántos kilómetros (aproximadamente) es la senda del Ventanón?", 1],
    ...
    #mostrarQuizz(){
        ...
        while(quizz.length > 0){
            ...
            document.querySelector("main").insertBefore(pregunta, p)
        }
    ...
    #comprobarRespuestas(){
        ...
        for (let i = 0; i < 10; i++) {
            ...
            for (let j = 0; j < 10; j++) {
                if( preguntas[i].querySelector("legend").textContent == this.#respuestas_correctas[j][0] &&
